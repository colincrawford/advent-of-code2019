...
update :: Instructions -> InstructionPointer -> Instructions
update instructions currentIndex =
    let firstNumLocation = instructions ! (currentIndex + 1)
        firstNum = instructions ! firstNumLocation

output :: Instructions -> InstructionPointer -> Instructions
output instructions currentIndex =
    let firstNumLocation = instructions ! (currentIndex + 1)
        firstNum = instructions ! firstNumLocation
...
runOpCode instructions currentInx 3 = (currentInx + 2, update)
runOpCode instructions currentInx 4 = (currentInx + 2, output)
